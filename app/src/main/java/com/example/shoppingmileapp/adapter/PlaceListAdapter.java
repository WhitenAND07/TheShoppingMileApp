...
import com.example.shoppingmileapp.ui.PlaceDetailActivity;
import com.example.shoppingmileapp.utils.GoogleApiUrl;
import com.example.shoppingmileapp.utils.HelperClass;
...
public class PlaceListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private class PlaceListAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private PlaceListAdapterViewHolder(View itemView) {
            ...
            mPlaceDistanceTextView =  itemView.findViewById(R.id.place_distance_text_view);
            mPlaceNameTextView =  itemView.findViewById(R.id.place_name);
            mPlaceAddressTextView =  itemView.findViewById(R.id.place_address);
            mPlaceOpenStatusTextView =  itemView.findViewById(R.id.place_open_status);
            mPlaceRating =  itemView.findViewById(R.id.place_rating);
