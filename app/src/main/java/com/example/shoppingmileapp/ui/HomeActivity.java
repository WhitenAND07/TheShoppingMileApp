package com.example.shoppingmileapp.ui;
...
import com.example.shoppingmileapp.adapter.HomeScreenItemListAdapter;
import com.example.shoppingmileapp.utils.PlaceDetailProvider;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.location_favourite_icon:
                        startActivity(new Intent(getApplicationContext(), FavouritePlaceListActivity.class));
                    ...
                    case R.id.share_icon:
                        ...
                        shareIntent.putExtra(Intent.EXTRA_TEXT, "Hey, Checkout ShoppingMileApp Application");
                    ...
                    case R.id.feedback_icon:
                        ...
                        mailToIntent.putExtra(Intent.EXTRA_EMAIL, new String[]{"yqz1280@gmail.com"});
                        startActivity(Intent.createChooser(mailToIntent, "Send Mail.."));
                        mDrawerLayout.closeDrawers();
                        break;

                    case R.id.about_icon:
                        Dialog aboutDialog = new Dialog(HomeActivity.this, R.style.AboutDialog);
