...
import com.example.shoppingmileapp.activities.Activity_Login;
...
public class SplashScreenActivity extends AppCompatActivity implements
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (LocationServices.FusedLocationApi.getLastLocation(mGoogleApiClient) != null) {
            mCurrentLocation = LocationServices.FusedLocationApi.getLastLocation(mGoogleApiClient).getLatitude() + "," + String.valueOf(
        ...
        switch (status.getStatusCode()) {
            case LocationSettingsStatusCodes.SUCCESS:
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    @Override
                    public void run() {
                        startActivity(new Intent(SplashScreenActivity.this, Activity_Login.class));
